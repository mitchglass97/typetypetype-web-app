...
*typetypetype* is a full-stack web app built with the PERN stack (PostgreSQL, Express, React and Node.js) and deployed on Heroku. The app keeps running stats of WPM and Accuracy as a user takes the typing speed test. Each instance of the test lasts 60 seconds.
